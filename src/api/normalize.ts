...
export function normalizeUser(raw: unknown): User {
  ...
  return {
    ...
    avatarUrl: asString(firstDefined(record.avatarUrl, record.avatar_url, record.avatar, record.photo, record.image, record.imageUrl), '') || null,
...
export function normalizeLedgerEntry(raw: unknown): LedgerEntry {
  ...
  return {
    ...
    refNo: asString(firstDefined(record.refNo, record.referenceNo, record.invoiceNo, record.billNo), ''),
    entryDate: asString(
      firstDefined(record.entryDate, record.date, record.txDate, record.purchaseDate, record.saleDate, record.createdAt),
      '',
    ),
    description: asString(firstDefined(record.description, record.note, record.notes, record.category), ''),
    note: asString(firstDefined(record.note, record.notes), ''),
    amount: asNumber(firstDefined(record.totalAmount, record.amount, record.grandTotal, record.total)),
    debit,
    credit,
