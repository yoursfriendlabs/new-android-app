    ...
    for (const pu of purchasesQuery.data ?? []) {
      ...
      if (match) {
        list.push({
          ...
          direction: pu.entryType === 'income' ? 'in' : 'out',
          type: pu.entryType === 'income' ? 'Income' : pu.entryType === 'expense' ? 'Expense' : 'Purchase',
          partyName: pu.partyName ? String(pu.partyName) : pu.entryType === 'income' ? 'Income' : 'Vendor / Expense',
